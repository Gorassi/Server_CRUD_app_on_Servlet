...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        System.out.println("second method:  filteredByStream");
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal userMeal : meals) {
            ...
            if (!map.containsKey(localDate)) {
                ...
                map.put(localDate, map.get(localDate) + calories);
            }
        }
        ...
        for (UserMeal userMeal : meals) {
            ...
            if (TimeUtil.isBetweenHalfOpen(userMeal.getDateTime().toLocalTime(), startTime, endTime))
                result.add(new UserMealWithExcess(userMeal.getDateTime(), userMeal.getDescription(), userMeal.getCalories(), isExceeded));
        }
...
//            for(UserMeal meal : userMeals) System.out.println("    :  " + meal.getDescription() + "  : " + meal.getCalories() );
//        }
        ...
        return meals.stream()
                ...
                .map(u -> new UserMealWithExcess(u.getDateTime(), u.getDescription(), u.getCalories(),
                        collect.get(u.getDateTime().toLocalDate()) > caloriesPerDay))
